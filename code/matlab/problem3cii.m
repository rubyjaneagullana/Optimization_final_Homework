% Problem 3(c-ii) – Narrower mainlobe (15°–25° window)
% -------------------------------------------------------------------------
% Repeats the robust formulation from Problem 3 to highlight trade-offs
% when shrinking the desired angular sector.
