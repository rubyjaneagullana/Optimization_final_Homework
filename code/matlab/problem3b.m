% Problem 3(b) – Worst-Case Sidelobe Minimization (40 antennas)
% -------------------------------------------------------------------------
% Same constraints as 3(a) but doubling the number of antennas to show how
% aperture boosts directivity (narrower mainlobe + lower sidelobes).
...
% setup
CARR_FREQ = 2.4e9;                         % Hz.
WAVE_LEN = physconst("LightSpeed") / CARR_FREQ;
